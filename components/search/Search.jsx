...
const Search = ({fromList,destination,checkin,checkout}) => {
  ...
  return (
    <>
      <div className="lg:max-h-[250px] mt-6">
        <div id="searchParams" className={fromList && "!shadow-none"}>
          <div>
            ...
            <h4 className="mt-2">
              <select name="destination" id="destination" value={searchTerm?.destination} onChange={handleInputs}>
      ...
      <button disabled={!allowSearch} className="search-btn" onClick={doSearch}>🔍️ {fromList ? "Modify Search": "Search"}</button>
    </>
  );
};
